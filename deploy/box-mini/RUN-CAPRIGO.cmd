...
if errorlevel 1 (
  ...
  start "Caprigo" /MIN cmd /c "cd /d C:\Users\box\caprigo && set CAPRIGO_BOX_PROFILE=1&& set OLLAMA_VULKAN=1&& set OLLAMA_IGPU_ENABLE=1&& node packages\gateway\dist\index.js"
